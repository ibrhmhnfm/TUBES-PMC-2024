...
1. Jalankan perintah kompilasi manual:
   ```
   gcc -o main main.c gcc -o main main.c utils/parsing.c algoritma/fungsi1.c algoritma/fungsi2.c algoritma/fungsi3.c algoritma/fungsi4.c algoritma/fungsi5.c
   ```
